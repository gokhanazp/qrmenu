...
function HomePageContent() {
  ...
  const showcaseItems = [
    {
      name: "L'amour Chocolate",
      url: "https://www.qrmenulist.com/restorant/lamour-chocolate-coffee",
      icon: "local_cafe",
    },
    {
      name: "Cebi Döner",
      url: "https://www.qrmenulist.com/restorant/cebi-doner",
      icon: "kebab_dining",
    },
    {
      name: "Riverside Burgers",
      url: "https://www.qrmenulist.com/restorant/riverside-burgers",
      icon: "lunch_dining",
    },
    {
      name: "Verna Cafe & Bistro",
      url: "https://www.qrmenulist.com/restorant/verna-cafe-bistro",
      icon: "local_cafe",
    },
    {
      name: "Cebi Döner",
          ...
          <div className="max-w-7xl mx-auto px-4 w-full">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="text-center lg:text-left order-2 lg:order-1">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl text-gray-400 mb-8 lg:mb-10 max-w-xl lg:mx-0 mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="relative">
              ...
              <div className="bg-white/5 p-8 pt-12 rounded-2xl border border-white/10 h-full">
                <span className="material-symbols-outlined text-violet-400 text-4xl mb-4 block">
                  person_add
                </span>
            ...
            <div className="relative">
              ...
              <div className="bg-white/5 p-8 pt-12 rounded-2xl border border-white/10 h-full">
                <span className="material-symbols-outlined text-fuchsia-400 text-4xl mb-4 block">
                  menu_book
                </span>
                <h3 className="text-xl font-bold mb-2">
            ...
            <div className="relative">
              ...
              <div className="bg-white/5 p-8 pt-12 rounded-2xl border border-white/10 h-full">
                <span className="material-symbols-outlined text-cyan-400 text-4xl mb-4 block">
                  share
                </span>
                <h3 className="text-xl font-bold mb-2">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {t.landing.testimonials.items.map((testimonial, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <div
                    className={`w-12 h-12 bg-gradient-to-br ${testimonialColors[i]} rounded-full flex items-center justify-center text-white font-bold`}
                  >
          ...
          <div className="max-w-7xl mx-auto px-4 py-16">
            <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
              <div className="lg:col-span-2">
                ...
                <div className="mb-6">
                  <h5 className="font-semibold mb-3 text-white/90">
                ...
                <div className="flex items-center gap-3">
                  <a
                    href="#"
                    className="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center hover:bg-violet-500/20 border border-white/10 transition-all"
                  >
                    <span className="material-symbols-outlined text-gray-400 hover:text-violet-400">
                      share
                    </span>
                  </a>
                  <a
                ...
                <ul className="space-y-4">
                  ...
                  <li>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-emerald-400 hover:text-emerald-300 transition-colors flex items-center gap-2 font-medium"
                    >
                ...
                <ul className="space-y-4">
                  ...
                  <li>
                    ...
                    >
                      ...
                      {t.landing.footer.support.community}
                    </Link>
                  </li>
                  <li>
                    <Link
                    ...
                    >
                      ...
                      {t.landing.footer.support.reportBug}
                    </Link>
                  </li>
                </ul>
              </div>
