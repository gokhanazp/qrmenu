    ...
    <>
      ...
      {showAbout && (
        <>
          ...
          {/* Modal */}
          <div
            className="fixed inset-x-4 top-1/2 -translate-y-1/2 max-w-md mx-auto z-[201] rounded-2xl shadow-2xl max-h-[80vh] overflow-y-auto"
          ...
          >
            ...
            <div className="p-6 space-y-6">
              ...
              {/* Social Media */}
              {(restaurant.whatsapp || restaurant.instagram || restaurant.facebook || restaurant.twitter) && (
                <section>
                  <h3
                    className="flex items-center gap-2 text-sm font-bold mb-3 uppercase tracking-wide"
                    style={{ color: textColor }}
